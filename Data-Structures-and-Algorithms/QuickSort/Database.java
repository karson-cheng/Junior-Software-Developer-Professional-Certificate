...
public class Database {
    ...
    private int partition(int highIndx, int lowIndx) {
        ...
        int pivotIndex = greaterThan_Indx + 1;
        ...
        //return 0;
        return pivotIndex + lowIndx;  // adjust for sub array offset
    }
